...
let favoriteFoods = ['steak', 'sushi', 'chicken', 'broccoli', 'fried rice'];
...
console.log('The new gems with the second gem replaced are:', gems);

// 5.b (STRETCH) TODO: Sort your gems array in reverse alphabetical order.
//     Please console.log the sorted array.
gems.sort();
gems.reverse();
// for(let index = gems.length-1)
// gems.sort((a, b) => (a > b ? -1 : 1));
console.log('The gems in reverse alphabetical order are:', gems);
...
console.log('The list of gems separated by "and" is:', gemString);
...
console.log('The gems and colors in one array looks like:', colorfulGems);
